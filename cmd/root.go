...
import (
	...
	accountDependency "account-service/internal/domain/account/v1"
	"account-service/pkg/gateway"
	"account-service/pkg/interceptors"
	"account-service/pkg/orm"
	"account-service/pkg/rpcclient"
	"account-service/pkg/rpcserver"
...
func runService(cmd *cobra.Command, args []string) {
	...
	accountDependency.RegisterServiceServer(rpcServer.Server, logger, sql)
	...
	err = accountv1.RegisterAccountServiceHandler(ctx, apiGateway.GetRuntimeMux(), client.UnaryConn)
	if err != nil {
